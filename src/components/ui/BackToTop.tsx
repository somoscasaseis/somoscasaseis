    ...
    <AnimatePresence>
      {isVisible && (
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          onClick={scrollToTop}
          className="fixed bottom-24 left-8 z-[9999] w-10 h-10 border border-[#1D2A34]/30 rounded-full flex items-center justify-center text-[#1D2A34] transition-all duration-300 group hover:border-[#1D2A34]"
