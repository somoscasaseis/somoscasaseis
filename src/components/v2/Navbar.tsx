  ...
  return (
    <header className="fixed top-6 left-1/2 -translate-x-1/2 w-[95%] max-w-6xl z-50">
      <div className="bg-[#EFEFED] rounded-full px-8 py-4 flex items-center justify-between shadow-sm">
        <div className="text-xl uppercase tracking-widest text-gray-900 font-sans">
          CASA SEIS
        </div>

        <nav className="hidden md:flex gap-8 text-[11px] font-medium uppercase tracking-[0.2em] text-gray-600 font-mono">
        ...
        <a
          ...
          className="border border-gray-900 text-gray-900 px-6 py-2 rounded-full text-[11px] font-medium uppercase tracking-widest hover:bg-gray-900 hover:text-white transition-colors inline-flex items-center gap-2 font-mono"
        >
          Contacto
