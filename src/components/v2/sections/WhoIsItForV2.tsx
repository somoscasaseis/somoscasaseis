      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="space-y-6">
          {targetItems.map((item, i) => (
            ...
            >
              <span className="text-2xl text-[#14627E] font-light mt-[-2px]">
                —
              </span>
              <p className="text-xl md:text-2xl text-[#14627E]/90 font-light tracking-wide leading-tight first-letter:uppercase">
                {item}
              </p>
            </motion.div>
          ))}
