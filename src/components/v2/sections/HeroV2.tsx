...
export const HeroV2 = () => {
  ...
  return (
    ...
    >
      ...
      {/* Contenido Hero */}
      <div className="relative mx-auto flex min-h-[72dvh] md:min-h-[80dvh] max-w-7xl items-center justify-center px-4 pt-20 md:pt-54 z-10">
        <motion.div
        ...
        >
          <motion.svg
            ...
            className="mt-7 mb-8 sm:mt-3 h-40 w-40 md:h-64 md:w-64 md:mt-0 text-[#1d2a34]"
	...
	c1.5-1,9.5,3.1,11.4,4.2c4,2.3,19.4,14.9,20.5,18.5C272.6,233.2,251.8,254.6,243.9,258.3"
          ...
          <motion.h1
            ...
            className="text-3xl md:text-4xl lg:text-5xl font-light uppercase tracking-[0.1em] text-center text-[#1d2a34] leading-[1.2] mb-14 font-sans"
          >
