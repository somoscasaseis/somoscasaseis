...
export const HeroV2 = () => {
  ...
  return (
	...
	c1.5-1,9.5,3.1,11.4,4.2c4,2.3,19.4,14.9,20.5,18.5C272.6,233.2,251.8,254.6,243.9,258.3"
              ...
              transition={{ delay: 0.2, duration: 1.8, ease: [0.65, 0, 0.35, 1] as const }}
            />
          </motion.svg>
          ...
          <motion.h1
            ...
            className="text-4xl md:text-5xl font-light uppercase tracking-[0.3em] text-center text-black leading-relaxed mb-10"
          >
