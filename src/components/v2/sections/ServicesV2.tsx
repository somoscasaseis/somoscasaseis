...
export const ServicesV2 = ({ services }: { services?: ServiceProps[] }) => {
  ...
  return (
    <section
      id="servicios"
      ref={sectionRef}
      className="relative bg-[#EFEFED] px-6 pt-24 pb-12 md:py-36 overflow-hidden scroll-mt-24 md:scroll-mt-20"
    >
      <div className="mx-auto max-w-7xl relative z-10 w-full flex flex-col items-center">
        <div className="mb-14 md:mb-24 flex flex-col items-center text-center w-full">
          <h2 className="mb-6 flex justify-center text-center text-3xl md:text-5xl font-medium text-foreground uppercase tracking-[0.18em] leading-tight w-full">
            <SplitReveal text="NUESTROS SERVICIOS" stagger={0.05} />
          </h2>
          <motion.p
            variants={introBlockVariantsMobile}
            initial="hidden"
            animate={isInView ? "visible" : "hidden"}
            className="text-xl md:text-2xl text-foreground/80 font-light mb-6 leading-relaxed max-w-2xl"
          >
