...
export const AboutV2 = () => {
  ...
  // Desktop: Original choreography with STOP
  const textOpacity = useTransform(smoothScroll, [0, 0.3, 0.7], [0, 1, 1]);
  const galleryContainerX = useTransform(smoothScroll, [0, 0.6, 1], ["0%", "50%", "50%"]);
  const widthFirst = useTransform(smoothScroll, [0, 0.6, 1], ["33.33%", "50%", "50%"]);
  const widthOthers = useTransform(smoothScroll, [0, 0.6, 1], ["33.33%", "25%", "25%"]);

  // Mobile only: Text and images appear separately
  const mobileTextOpacity = useTransform(smoothScroll, [0.02, 0.15], [0, 1]);
  const mobileTextY = useTransform(smoothScroll, [0.02, 0.15], [20, 0]);
  
  const img1Opacity = useTransform(smoothScroll, [0.15, 0.25], [0, 1]);
  const img1Y = useTransform(smoothScroll, [0.15, 0.25], [30, 0]);
  const img2Opacity = useTransform(smoothScroll, [0.15, 0.25], [0, 1]);
  const img2Y = useTransform(smoothScroll, [0.15, 0.25], [30, 0]);
  const img3Opacity = useTransform(smoothScroll, [0.15, 0.25], [0, 1]);
  const img3Y = useTransform(smoothScroll, [0.15, 0.25], [30, 0]);
